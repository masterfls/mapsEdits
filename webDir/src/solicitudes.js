const renderizar = addEventListener("DOMContentLoaded", () => {
    ...
    const response = async () => {
        ...
        const user = await axios.get("https://www.ievg.online/users/id", {params: {id: id.id}});
        ...
        if(rol === 'admin'){
            ...
            const data = await axios.get("https://www.ievg.online/users/disabled")
...
const userRole = async(user, rol) =>{
    ...
    await axios.put("https://www.ievg.online/users/update", {
        id: user.id,
        role: rol
    })
...
const userDelete = async(id) => {
    await axios.delete("https://www.ievg.online/users/delete", {params: {id: id}})
}
